...
function calculate() {
  ...
  } else if(numbers.some(num => num < 1 || num > 100)) {
    alert("Please enter 10 numbers between 1 and 100.");
    document.getElementById("data").value= "";
  } else {
...
function validateForm() {
  ...
  if (errorDisplay != "") {
    ...
    //document.getElementById("average").innerHTML = "Enter your zip code";
    return true;
  }
}
...
function resetForm() {
  //document.getElementById("surveyForm").reset();
  //Span elements needs to be reset manually
